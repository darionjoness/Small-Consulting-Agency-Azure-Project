...
## Create Function App
```
az functionapp create --resource-group rg-contoso-dev-eastus-001 --consumption-plan-location eastus --name contoso-func-app-123 --storage-account stcontoso123456 --runtime python --os-type linux --tags Environment=Development
```
